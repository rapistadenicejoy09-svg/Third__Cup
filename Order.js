...
const Order = () => {
  ...
  const menuItems = {
    drinks: [
      { name: 'Espresso', price: 125, icon: '☕' },
      { name: 'Cappuccino', price: 175, icon: '☕' },
      { name: 'Latte', price: 200, icon: '☕' },
      { name: 'Mocha', price: 225, icon: '☕' },
      { name: 'Americano', price: 150, icon: '☕' },
      { name: 'Macchiato', price: 180, icon: '☕' },
      { name: 'Flat White', price: 190, icon: '☕' },
      { name: 'Cold Brew', price: 210, icon: '🧊' },
      { name: 'Affogato', price: 240, icon: '🍨' },
      { name: 'Irish Coffee', price: 280, icon: '🥃' }
    ],
    pastries: [
      { name: 'Croissant', price: 120, icon: '🥐' },
      { name: 'Banana Bread', price: 130, icon: '🍞' },
      { name: 'Cinnamon Roll', price: 140, icon: '🍩' },
      { name: 'Baguette', price: 110, icon: '🥖' }
    ]
  };
